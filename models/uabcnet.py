...
class ResUNet_encoder1(nn.Module):
	def __init__(self, in_nc=4, out_nc=3, nc=[64, 128, 256, 512], nb=2, act_mode='R', downsample_mode='strideconv', upsample_mode='convtranspose'):
		super(ResUNet_encoder1, self).__init__()
...
class ResUNet_encoder3(nn.Module):
	def __init__(self, in_nc=4, out_nc=3, nc=[64, 128, 256, 512], nb=2, act_mode='R', downsample_mode='strideconv', upsample_mode='convtranspose'):
		super(ResUNet_encoder3, self).__init__()
...
class ResUNet_encoder4(nn.Module):
	def __init__(self, in_nc=4, out_nc=3, nc=[64, 128, 256, 512], nb=2, act_mode='R', downsample_mode='strideconv', upsample_mode='convtranspose'):
		super(ResUNet_encoder4, self).__init__()
...
class ResUNet_encoder5(nn.Module):
	def __init__(self, in_nc=4, out_nc=3, nc=[64, 128, 256, 512], nb=2, act_mode='R', downsample_mode='strideconv', upsample_mode='convtranspose'):
		super(ResUNet_encoder5, self).__init__()
...
class ResUNet_decoder(nn.Module):
	def __init__(self, in_nc=4, out_nc=3, nc=[64, 128, 256, 512], nb=2, act_mode='R', downsample_mode='strideconv',
		...
		self.m_final1 = B.conv(out_nc, out_nc, kernel_size=1, bias=False, mode='C')
		self.m_final2 = B.conv(out_nc, out_nc, kernel_size=1, bias=False, mode='C')
...
class UABCNet(nn.Module):
	def __init__(self, n_iter=5, h_nc=64, in_nc=4, out_nc=3, nc=[64, 128, 256, 512], nb=2, sf=4, act_mode='R', downsample_mode='strideconv', upsample_mode='convtranspose'):
		...
		self.proj_encoder1 = ResUNet_encoder1(in_nc=in_nc, out_nc=out_nc, nc=nc, nb=nb, act_mode=act_mode,
							downsample_mode=downsample_mode, upsample_mode=upsample_mode)
		self.proj_encoder2 = ResUNet_encoder2(in_nc=in_nc, out_nc=out_nc, nc=nc, nb=nb, act_mode=act_mode,
											downsample_mode=downsample_mode, upsample_mode=upsample_mode)
		self.proj_encoder3 = ResUNet_encoder3(in_nc=in_nc, out_nc=out_nc, nc=nc, nb=nb, act_mode=act_mode,
											downsample_mode=downsample_mode, upsample_mode=upsample_mode)
		self.proj_encoder4 = ResUNet_encoder4(in_nc=in_nc, out_nc=out_nc, nc=nc, nb=nb, act_mode=act_mode,
											downsample_mode=downsample_mode, upsample_mode=upsample_mode)
		self.proj_encoder5 = ResUNet_encoder5(in_nc=in_nc, out_nc=out_nc, nc=nc, nb=nb, act_mode=act_mode,
											downsample_mode=downsample_mode, upsample_mode=upsample_mode)
		self.proj_decoder = ResUNet_decoder(in_nc=in_nc, out_nc=out_nc, nc=nc, nb=nb, act_mode=act_mode,
											downsample_mode=downsample_mode, upsample_mode=upsample_mode)
		self.proj_encoders=[]

		self.proj_encoders.append(self.proj_encoder1)
		self.proj_encoders.append(self.proj_encoder2)
		self.proj_encoders.append(self.proj_encoder3)
		self.proj_encoders.append(self.proj_encoder4)
		self.proj_encoders.append(self.proj_encoder5)


		self.proj_encoder1.in_channels = in_nc
		self.proj_encoder2.in_channels = in_nc
		self.proj_encoder3.in_channels = in_nc
		self.proj_encoder4.in_channels = in_nc
		self.proj_encoder5.in_channels = in_nc
		self.proj_decoder.in_channels = in_nc
	...
	def forward_patchwise_SR(self, y, k, ab, patch_num=[2, 2], patch_size=[128, 128], sf=4):
		...
		for i in range(self.n):
			...
			for idx in range(patch_num[0]*patch_num[1]):
				...
				z_p = self.deconv(z[idx:idx+1], Fk_all[idx], FkC_all[idx], F2k_all[idx], FkCFy_all[idx], mu_p, sf)
				z_temp.append(z_p)
			...
			if self.proj_encoder1.in_channels == 4:
