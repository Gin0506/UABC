...
def main():
	...
	pre_files = '/home/xiu/databag/deblur/models/bench/uabcnet_{}.pth'.format(model_code)
	...
	#ab_buffer[:,:,0,:] = 0.01
	ab_buffer = np.loadtxt('/home/xiu/databag/deblur/models/bench/ab_{}.txt'.format(model_code)).astype(np.float32).reshape(gx,gy,stage*2,3)
	...
	while running:
		...
		if global_iter % 100 ==0:
			...
			torch.save(model.state_dict(),'/home/xiu/databag/deblur/models/bench/uabcnet_iter{}.pth'.format(global_iter))
			np.savetxt('/home/xiu/databag/deblur/models/bench/ab_iter{}.txt'.format(global_iter),ab_numpy)
			cv2.imwrite('/home/xiu/databag/deblur/models/bench/show_iter{}.png'.format(global_iter),save_image)
