...
def main():
	...
	model_code = 'iter800'
	loaded_state = torch.load('/home/xiu/databag/deblur/models/plano/uabcnet_{}.pth'.format(model_code))
	...
	#for img_id in range(1,12):
		...
		img_L = cv2.imread('/home/xiu/databag/deblur/ICCV2021/MPI_data/drain/blurry.jpg')
		...
		ab_numpy = np.loadtxt('/home/xiu/databag/deblur/models/plano/ab_{}.txt'.format(model_code)).astype(np.float32).reshape(gx,gy,stage*2,3)
